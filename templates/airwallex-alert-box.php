...
<div class="wc-airwallex-alert-box <?php echo esc_attr( $awxAlertBoxClass ); ?> <?php echo esc_attr($awxAlertAdditionalClass); ?>" style="display: none;">
    <img src="<?php echo esc_url( AIRWALLEX_PLUGIN_URL . '/assets/images/' . $awxAlertBoxIcon ); ?>"></img>
