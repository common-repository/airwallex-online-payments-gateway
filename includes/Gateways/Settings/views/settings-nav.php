...
<div class="wc-airwallex-settings-logo">
	...
	<span id="awx-account-connected" style="display: <?php echo esc_attr( $this->isConnected() ? 'inline-block' : 'none' ); ?>; padding: 3px 8px; font-weight:bold; border-radius:3px; background-color:#E0F7E7">Connected</span>
	<span id="awx-account-not-connected" style="display: <?php echo esc_attr( $this->isConnected() ? 'none' : 'inline-block' ); ?>; padding: 3px 8px; font-weight:bold; border-radius:3px; background-color:#FFADAD">Not Connected</span>
</div>
